(function (j, h, c, g, d, k, f) { /*! Jssor */
    ...
    var b = j.$Jssor$ = new function () {
            ...
            function s(h, l) {
                ...
                s = function (e, c) {
                    ...
                    if (c.rg) if (d) xb(i.$CreateCallback(g, Q, e, c));
                    else a(e, c)
                };
                i.kc = Q;
                if (d) i.kc = s;
    ...
    var m = {
        ...
        yb: "data-autocenter"
            ...
            h.$FormationStraight = function (f) {
                for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.bc, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t - 1, c, b = 0; b < e; b++) for (a = 0; a < d; a++) {
                    switch (s) {
                        case j:
                            c = h - (a * e + (q - b));
                            break;
        ...
        function j(h, f, g) {
            ...
            a.ie = function (c, b) {
                ...
                if (!a.oc[f]) {
                    ...
                    for (var d = 0; d < a.$Cols; d++) for (var e = 0; e < a.$Rows; e++) a.oc[f][e + "," + d] = {
                        $Top: e * b,
                        $Right: d * c + c,
                        $Bottom: e * b + b,
                        $Left: d * c
    ...
    var i = j.$JssorSlider$ = function () {
        ...
        var Fb = "data-jssor-slider",
            ...
            jc = 1,
            Xb = 1,
            ac = {}, y, X, Db, Rb, Ob, ob, rb, qb, jb, s = -1,
