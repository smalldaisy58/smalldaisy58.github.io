...
function filtersClear() {
    $(".js-filters").find('input[type="checkbox"]').prop("checked", !1), $(".js-filters-bts").slideUp(250)
}
function filters() {
    $(".js-filters").each(function () {
        $(this)
    }), $(".js-filters-title").on("click", function () {
        $(this).closest(".js-filters-section").toggleClass("is-open").find(".js-filters-list").slideToggle(300)
    }), $(".js-filters-item").on("change", function () {
        0 === $(".js-filters").find('input[type="checkbox"]:checked').length ? $(".js-filters-bts").slideUp(250) : $(".js-filters-bts").slideDown(250)
    }), $(".js-filters-delete").on("click", function () {
        filtersClear()
    })
}
function productsSimple() {
    $(".js-product-simple").hover(function () {
        $(this).css("overflow", "visible")
    }, function () {
        var e = $(this);
        setTimeout(function () {
            e.is(":hover") || e.css("overflow", "hidden")
        }, 350)
    })
}
function home() {
    $(".js-home-video").length > 0 && (Modernizr.video && !mobileDetect.mobile() ? ($(".js-home-video").get(0).play(), Modernizr.objectfit || $(".js-home-video").coverVid(640, 360)) : $(".js-home-video").remove()), $(".js-news-video").length > 0 && (Modernizr.video && !mobileDetect.mobile() ? ($(".js-news-video").get(0).play(), Modernizr.objectfit || $(".js-news-video").coverVid(640, 360)) : $(".js-news-video").remove())
}
function search() {
    $.fn.setCursorPosition = function (e) {
        ...
        searchValPrev = $(this).val()
    }).on("keyup", function (e) {
        searchVal = $(this).val(), searchVal != searchValPrev && searchAction()
    }), $(document).on("keydown", function (e) {
        if (e.keyCode != KEYCODE_CTRL && e.keyCode != KEYCODE_CMD && e.keyCode != KEYCODE_CMD_RIGHT || (ctrlDown = !0), $search.is(":visible")) e.which == KEYCODE_ESC ? (searchClose(), $searchInput.trigger("blur")) : (e.which >= 48 && e.which <= 90 || e.which >= 96 && e.which <= 105 || e.shiftKey === !0 && (e.which >= 48 && e.which <= 90 || e.which >= 96 && e.which <= 105)) && $searchInput.trigger("focus");
        else if (!ctrlDown || e.keyCode != KEYCODE_V && e.keyCode != KEYCODE_C && e.keyCode != KEYCODE_R) {
            var t = e.target.nodeName.toLowerCase();
            "input" != t && "textarea" != t && "select" != t && (e.which >= 48 && e.which <= 90 || e.which >= 96 && e.which <= 105 || e.shiftKey === !0 && (e.which >= 48 && e.which <= 90 || e.which >= 96 && e.which <= 105)) && ($searchInput.trigger("focus"), searchValPrev = $searchInput.val(), $searchInput.val(String.fromCharCode(e.which).toLowerCase()), window.setTimeout(function () {
                $searchInput.setCursorPosition($searchInput.val().length)
            }, 0), searchVal = $searchInput.val(), searchOpen())
        } else;
    }).on("keyup", function (e) {
        e.keyCode != KEYCODE_CTRL && e.keyCode != KEYCODE_CMD && e.keyCode != KEYCODE_CMD_RIGHT || (ctrlDown = !1)
    }), $(".js-search-close").on("click", function () {
        searchClose()
    })
}
function searchOpen() {
    Modernizr.touchevents ? $(".js-search-mini").hasClass("is-always-open") ? $(".js-search-mini-input:eq(0)").trigger("focus") : ($("body").toggleClass("is-search-mini-open"), $(".js-search-mini").toggleClass("is-open"), $(".js-search-mini").hasClass("is-open") && $(".js-search-mini-input:eq(0)").trigger("focus")) : $(".js-search").is(":visible") || ($(".js-search-results, .js-search-loading, .js-search-msg, .js-search-list").hide(), searchAction(), $(".js-search").fadeIn(250, function () {
        mobileDetect.is("iOS") && $searchInput.attr("placeholder", "Escribe aquí"), $searchInput.trigger("focus")
    }))
}
function searchClose() {
    $("body").removeClass("is-blocked"), $(".js-search, .js-search-backdrop").fadeOut(250)
}
function formEmpleoCv() {
    var e = !0,
        t = $(".js-form-cv"),
        n = t.find(".js-alert-ok"),
        i = t.find(".js-alert-error");
    return n.addClass("hidden"), i.addClass("hidden"), t.find(".js-required").each(function () {
        $this = $(this), $this.val($.trim($this.val()));
        var t = $(this).val();
        "" === t ? (e = !1, $this.closest(".form-group").addClass("has-error")) : ("email" != $this.attr("type") || validateEmail(t)) && ("tel" != $this.attr("type") || validatePhone(t)) && ("checkbox" != $this.attr("type") || $this.prop("checked")) ? $this.closest(".form-group").removeClass("has-error") : (e = !1, $this.closest(".form-group").addClass("has-error"))
    }), !e && t.find(".has-error").length > 0 && (i.removeClass("hidden"), t.find(".has-error .js-required").first().focus(), setTimeout(function () {
        $("html, body").animate({
            scrollTop: i.offset().top - $(".js-main-header").outerHeight() - 10
        }, 300)
    }, 250)), e
}
function formShowroomVisita() {
    var e = !0,
        t = $(".js-form-showroom"),
        n = t.find(".js-alert-ok"),
        i = t.find(".js-alert-error");
    return n.addClass("hidden"), i.addClass("hidden"), t.find(".js-required").each(function () {
        $this = $(this), $this.val($.trim($this.val()));
        var t = $(this).val();
        "" === t ? (e = !1, $this.closest(".form-group").addClass("has-error")) : ("email" != $this.attr("type") || validateEmail(t)) && ("checkbox" != $this.attr("type") || $this.prop("checked")) ? $this.closest(".form-group").removeClass("has-error") : (e = !1, $this.closest(".form-group").addClass("has-error"))
    }), !e && t.find(".has-error").length > 0 && i.removeClass("hidden"), e
}
function formNewsletter() {
    var e = !0,
        t = $(".js-form-newsletter"),
        n = t.find(".js-alert-ok"),
        i = t.find(".js-alert-error");
    return n.addClass("hidden"), i.addClass("hidden"), t.find(".js-required").each(function () {
        $this = $(this), $this.val($.trim($this.val()));
...
function formLogin() {
    var e = !0,
        t = $(".js-form-login"),
        n = t.find(".js-alert-login-error");
    return n.addClass("hidden"), t.find(".js-required").each(function () {

        $this = $(this), $this.val($.trim($this.val()));
        var t = $(this).val();
        "" === t ? (e = !1, $this.closest(".form-group").addClass("has-error")) : "email" != $this.attr("type") || validateEmail(t) ? $this.closest(".form-group").removeClass("has-error") : (e = !1, $this.closest(".form-group").addClass("has-error"))
    }), !e && t.find(".has-error").length > 0 && (n.removeClass("hidden"), t.find(".has-error .js-required").first().focus()), e
}
function formRememberPassword() {
    var e = !0,
        t = $(".js-form-remember"),
        n = t.find(".js-alert-remember-error");
    return n.addClass("hidden"), t.find(".js-required").each(function () {
        $this = $(this), $this.val($.trim($this.val()));
        var t = $(this).val();
        "" === t ? (e = !1, $this.closest(".form-group").addClass("has-error")) : "email" != $this.attr("type") || validateEmail(t) ? $this.closest(".form-group").removeClass("has-error") : (e = !1, $this.closest(".form-group").addClass("has-error"))
    }), !e && t.find(".has-error").length > 0 && (n.removeClass("hidden"), t.find(".has-error .js-required").first().focus(), setTimeout(function () {
        $("html, body").animate({
            scrollTop: n.offset().top - $(".js-main-header").outerHeight() - 10
        }, 300)
    }, 250)), e
}
...
function tabletNav() {
    $(".tablet-nav-blocker").on("mousedown touchstart touchmove", function (e) {
        e.preventDefault(), e.stopPropagation(), $(".js-tablet-nav-link").removeClass("is-active"), $("html").removeClass("tablet-nav-opened"), setTimeout(function () {
            $("html").removeClass("tablet-nav-opening"), $(".js-main-wrap").css("min-height", 0)
        }, 450), 0 === $(".js-tablet-nav-link.is-active").length && $('.js-tablet-nav-link[data-subnav="' + section + '"]').addClass("is-active")
    }), $(".js-tablet-nav-link").on("click", function (e) {
        var t = $(this),
            n = t.data("subnav"),
            i = $(".js-tablet-subnav-section-" + n);
        i.length > 0 && (e.preventDefault(), currentTabletNav != n && (t.hasClass("is-active") && $("html").hasClass("tablet-nav-opened") ? ($("html").removeClass("tablet-nav-opened"), setTimeout(function () {
            $("html").removeClass("tablet-nav-opening"), $(".js-main-wrap").css("min-height", 0)
        }, 450), $(".js-tablet-nav-link").removeClass("is-active"), 0 === $(".js-tablet-nav-link.is-active").length && $('.js-tablet-nav-link[data-subnav="' + section + '"]').addClass("is-active")) : ($(".js-tablet-nav-link").removeClass("is-active"), t.addClass("is-active"), $(".js-tablet-subnav-section").removeClass("is-active"), i.addClass("is-active"), $("html").addClass("tablet-nav-opening"), $(".js-main-wrap").css("min-height", $(window).height()), setTimeout(function () {
            $("html").addClass("tablet-nav-opened")
        }, 10))))
    })
}
function tabs() {
    $(".js-tab").on("click", function () {
        $(this).closest(".js-tabs").find(".js-tab").removeClass("is-active"), $(this).addClass("is-active")
    })
}
function smoothScroll() {
    $(".js-smooth-scroll").on("click", function (e) {
        var t = $($(this).attr("data-href"));
        0 === t.length && (t = $($(this).attr("href"))), t.length > 0 && (e.preventDefault(), $("html, body").animate({
            scrollTop: t.offset().top - $(".js-main-header").outerHeight()
        }, 300))
    })
}
function carouselProducts() {
    $(".js-carousel-products").each(function () {
        var e = $(this),
            t = e.find(".js-carousel-products-item").length,
            n = !1,
            i = !1,
            o = !1,
            r = !0,
            ...
            l = !1,
            c = !1;
        1 == t && (i = !0), Modernizr.touchevents && (i = !0, r = !1, o = !0, s = 0, a = 70, l = !0, c = !0);
        var u = e.find(".js-carousel-products-nav-prev").html(),
            d = e.find(".js-carousel-products-nav-next").html();
        e.find(".js-owl-carousel").owlCarousel({
            items: 1,
            loop: n,
            nav: r,
            navText: [u, d],
            ...
            onInitialized: function () {
                e.css("visibility", "visible"), t < 2 && e.find(".js-owl-carousel").addClass("no-center"), t > 1 && e.find(".owl-stage").outerWidth() - 10 > e.find(".owl-stage-outer").outerWidth() && e.find(".owl-controls").css("display", "block")
            },
            onResized: function () {
                t > 1 && e.find(".owl-stage").outerWidth() - 10 > e.find(".owl-stage-outer").outerWidth() ? e.find(".owl-controls").css("display", "block") : e.find(".owl-controls").css("display", "none")
            }
        })
    })
}
function productGraphs() {
    var e = [],
        t = [];
    $(".js-graph-environment").each(function (n, i) {
        var o = $(this).attr("id"),
            r = $(this).find(".js-graph-value").text(),
            s = $(this).find(".js-graph-text").text(),
            a = "#eee",
            l = "#AFE493";
        $(this).hasClass("is-dark-green") && (l = "#00B500"), t[n] = o, e[n] = Circles.create({
            id: o,
            radius: 140,
            value: r,
            maxValue: 100,
            width: 8,
            text: function (e) {
                return '<div class="environment__graph__content"><span class="environment__graph__percent">' + e + '%</span><span class="environment__graph__desc">' + s + "</span></div>"
            },
            colors: [a, l],
            duration: 0,
        ...
        for (var n = 0; n < e.length; n++) e[n].updateRadius(Math.round(($("#" + t[n]).closest(".environment__graph").width() - 2) / 2))
    })
}
function navShow(e) {
    var t = e.data("subnav");
...
function lightboxGallery() {
    var e = function (e) {
        for (var t = function (e) {
            for (var t, n, i, o = e.querySelectorAll(".js-gallery-item"), r = o.length, s = [], a = 0; a < r; a++) t = o[a], 1 === t.nodeType && (n = t.getAttribute("data-size").split("x"), i = {
                src: t.getAttribute("href"),
                w: parseInt(n[0], 10),
                h: parseInt(n[1], 10),
                title: t.getAttribute("data-caption")
            }, i.el = t, s.push(i));
            return s
        }, n = function l(e, t) {
            ...
            var t = e.target || e.srcElement,
                i = t.parentNode;
            if (i) {
                for (var r, s = n(t, function (e) {
                    return e.classList.contains("js-gallery")
                }), a = s.querySelectorAll(".js-gallery-item"), l = a.length, c = 0, u = 0; u < l; u++) if (1 === a[u].nodeType) {
                    if (a[u] === i) {
                        r = c;
                        break
                    }
            ...
            s = t(n), r = {
                ...
                getThumbBoundsFn: function (e) {
                    var t = s[e].el.firstElementChild,
                ...
                errorMsg: '<div class="pswp__error-msg"><a href="%url%" target="_blank">La imagen</a> no se ha podido cargar.</div>',
                isClickableElement: function (e) {
                    return "A" === e.tagName || "SVG" === e.tagName
                }
            }, r.index = parseInt(e, 10), isNaN(r.index) || (i && (r.showAnimationDuration = 0), o = new PhotoSwipe(a, PhotoSwipeUI_Default, s, r), o.init())
        }, r = document.querySelectorAll(".js-gallery-item"), s = 0, a = r.length; s < a; s++) r[s].setAttribute("data-pswp-uid", s + 1), r[s].onclick = i;
        return gallery
    };
    e(".js-gallery")
}
function hide_gallery_images() {
    "" === html_gallery_images && (html_gallery_images = $(".js-gallery").html()), "" !== html_gallery_images && $(".js-gallery").html(html_gallery_images), lightboxGallery(), cont = 1, position_gallery = $(".js-gallery").offset().top, $(".js-gallery-item").each(function () {
        cont++, $(this).removeClass("hidden"), position_image = $(this).offset().top, position_gallery + 20 < position_image && ($(this).addClass("hidden"), $(".js-gallery-buttons").removeClass("hidden"))
    }), setTimeout(function () {
        calculate_gallery_images()
    }, 500)
}
function calculate_gallery_images() {
    cont = 1, width_gallery = $(".js-gallery").css("width"), v = width_gallery.split("px"), width_gallery = v[0], total_width_images = 0, $(".js-gallery-item:not(.hidden)").each(function () {
        width_image = $(this).css("width"), v = width_image.split("px"), width_image = v[0], total_width_images += parseInt(width_image), cont++
    }), total_visibles = $(".js-gallery-item:not(.hidden)").length, cont = 1, $(".js-gallery-item:not(.hidden)").each(function () {
        width_image = $(this).css("width"), v = width_image.split("px"), width_image = v[0], new_width = width_gallery * width_image / total_width_images, width_gallery >= 1300 ? total_visibles <= 5 ? new_width -= .01 * new_width : new_width -= .015 * new_width : total_visibles <= 5 ? new_width -= .015 * new_width : new_width -= .02 * new_width, cont++, $(this).css("width", new_width)
    })
}
function has_hidden_gallery_images() {
    my_to && clearTimeout(my_to), my_to = setTimeout(function () {
        hide_gallery_images()
    }, 1e3)
}
function lightboxVideo() {
    ...
    }), $(".js-lightbox-video-iframe").magnificPopup({
        type: "iframe",
        removalDelay: 300,
        mainClass: "mfp-zoom-in mfp-iframe",
        gallery: {},
        iframe: {
            markup: '<div class="mfp-iframe-scaler"><div class="mfp-close mfp-close-iframe"></div><iframe class="mfp-iframe" frameborder="0" allowfullscreen></iframe></div>',
            patterns: {
                youtube: {
                    src: "//www.youtube.com/embed/%id%?rel=0&autoplay=0&modestbranding=0&showinfo=0&iv_load_policy=0&autohide=1&rel=0&feature=player_embedded&wmode=transparent"
                }
...
function videoHeroInline() {
    $(".js-hero-video-inline").on("click", function (e) {
        var t = $(this),
            n = t.attr("href").split("?v=");
        n[1] && (e.preventDefault(), $(this).closest(".js-hero").append('<iframe class="hero__iframe" src="//www.youtube.com/embed/' + n[1] + '?rel=0&amp;autoplay=0&amp;modestbranding=0&amp;showinfo=0&amp;iv_load_policy=0&amp;autohide=1&amp;rel=0&amp;feature=player_embedded&amp;wmode=transparent" frameborder="0" allowfullscreen=""></iframe>'))
    })
}
function gallery() {
    $(".js-gallery").on("click", ".js-gallery-bt-more", function (e) {
        e.preventDefault();
        $(this).closest(".js-gallery-wrap").find(".js-gallery-item.hidden").first();
        $(this).closest(".js-gallery-wrap").find(".js-gallery-item").removeClass("hidden"), $(".js-gallery-buttons").hide();
        try {
            parent.pv = 1, parent.sendMessage()
        } catch (t) {}
    })
}
function galleryFlex() {
    new flexImages({
        selector: ".js-gallery-gflex",
        container: ".js-gallery-gflex-item",
        rowHeight: 320,
        maxRows: 1
    }), new flexImages({
        selector: ".js-gallery-gflex-two",
        container: ".js-gallery-gflex-item",
        rowHeight: 320,
        maxRows: 2
    }), new flexImages({
        selector: ".js-gallery-gflex-all",
        container: ".js-gallery-gflex-item",
        rowHeight: 320
    }), new flexImages({
        selector: ".js-gallery-gflex-vcw",
        container: ".js-gallery-gflex-item",
        rowHeight: 800
    }), $(".js-gallery-gflex-bt-more").on("click", function (e) {
        e.preventDefault(), new flexImages({
            selector: ".js-gallery-gflex",
            container: ".js-gallery-gflex-item",
            rowHeight: 320
        }), new flexImages({
            ...
            container: ".js-gallery-gflex-item",
            rowHeight: 320
        }), $(".js-gallery-gflex-btns").hide()
    }), total_ocultos = $(".js-gallery-gflex-item").filter(function () {
        return "none" == $(this).css("display")
    }).length, total_ocultos < 1 && $(".js-gallery-gflex-bt-more").hide()
}
function dropdownCustom() {
    $(".js-dropdown-custom").select2({
        minimumResultsForSearch: 1 / 0
    }), $(".js-dropdown-custom-search").select2();
    var e = $(".js-dropdown-custom-goto").select2({
        minimumResultsForSearch: 1 / 0
    });
    e.on("select2:select", function (e) {
        window.location.href = e.params.data.element.parentElement.dataset.url + e.params.data.id
    })
}
function arquitectos_showrooms() {
    Modernizr.touchevents || $(".js-showroom-item").on("mouseenter", function () {
        $(".js-showroom-hero").css("background-image", "url(" + $(this).data("image") + ")")
    })
}
function windowLoad() {
    $("html").addClass("browser-loaded")
}
...
function promoWallyGoTo(e) {
    $(".js-promo-wally-step").hide(), $(".js-promo-wally-step-" + e).fadeIn(250)
}
function promoWallyOpen() {
    $("body").addClass("is-blocked"), $(".js-promo-wally-results, .js-promo-wally-loading, .js-promo-wally-msg, .js-promo-wally-list").hide(), promoWallyGoTo("1"), $(".js-promo-wally-backdrop").show(), $(".js-promo-wally").fadeIn(250)
}
function promoWallyClose() {
    $("body").removeClass("is-blocked"), $(".js-promo-wally, .js-promo-wally-backdrop").fadeOut(250)
}
function promoWallyCountdown(e) {
    promoWallySegundos = e, e <= 9 ? $(".js-promo-wally-clock").html("00:0" + e) : $(".js-promo-wally-clock").html("00:" + e), e >= 1 ? (e -= 1, promoWallyTimer = setTimeout(function () {
        promoWallyCountdown(e)
    }, 1e3)) : (clearTimeout(promoWallyTimer), promoWallyGoTo("3-gameover"))
}
function promoWallyEmpezar() {
    _url_get_promo = base_url_lang + "promo_wally/find", promoWallyGoTo("2"), $(".js-promo-wally-step-2").html('<div class="container-fluid container--812"><div class="promo-wally-loading"><div class="block-text"><p>Loading...</p></div></div></div>'), $.get(_url_get_promo, function (e) {
        $(".js-promo-wally-step-2").html(e.html), promoWallyCountdown(60)
    })
}
function promoWallyEncontrado(e) {
    promoWallyElemento = e, clearTimeout(promoWallyTimer), $("#token_promo").val($("#token_find").val()), promoWallyGoTo("3-win")
}
function promoWallyEnviarForm() {
    return _url_promo_form = base_url_lang + "promo_wally/save", form_promo_wally() && ($("#promo_form button").hide(), $.post(_url_promo_form, {
        ...
        "OK" == e.status ? ($("#display_error").hide(), $("#promo_form").hide(), $("#display_ok").show()) : ($("#promo_form button").show(), $("#display_error").show(), $("#errores_div").html(e.error_msg))
    })), !1
}
function promoWally_fase2GoTo(e) {
    $(".js-promo-wally_fase2-step").hide(), $(".js-promo-wally_fase2-step-" + e).fadeIn(500)
}
function promoWally_fase2Open() {
    $("body").addClass("is-blocked"), $(".js-promo-wally_fase2-results, .js-promo-wally_fase2-loading, .js-promo-wally_fase2-msg, .js-promo-wally_fase2-list").hide(), promoWally_fase2GoTo("1"), $(".js-promo-wally_fase2-backdrop").show(), $(".js-promo-wally_fase2").fadeIn(250)
}
function promoWally_fase2Close() {
    $("body").removeClass("is-blocked"), $(".js-promo-wally_fase2, .js-promo-wally_fase2-backdrop").fadeOut(500)
}
function promoWally_fase2Countdown(e) {
    promoWally_fase2Segundos = e, minutos = Math.floor(e / 60), minutos >= 1 ? (segundos_restantes = e - 60 * minutos, minutos <= 9 ? minutos_txt = "0" + minutos + ":" : minutos_txt = minutos + ":", segundos_restantes <= 9 ? $(".js-promo-wally_fase2-clock").html(minutos_txt + "0" + segundos_restantes) : $(".js-promo-wally_fase2-clock").html(minutos_txt + segundos_restantes)) : e <= 9 ? $(".js-promo-wally_fase2-clock").html("00:0" + e) : $(".js-promo-wally_fase2-clock").html("00:" + e), e >= 1 ? (e -= 1, promoWally_fase2Timer = setTimeout(function () {
        promoWally_fase2Countdown(e)
    }, 1e3)) : (clearTimeout(promoWally_fase2Timer), promoWally_fase2GoTo("3-gameover"))
}
function promoWally_fase2Empezar() {
    _url_get_promo = base_url_lang + "promo_wally/find_fase2", promoWally_fase2GoTo("2"), wallyTotalElements = 0, wallyElements = [], wally_fase2_finished = !1, $(".js-promo-wally_fase2-step-2").html('<div class="container-fluid container--812"><div class="promo-wally-loading"><div class="block-text"><p>Loading...</p></div></div></div>'), $.post(_url_get_promo, {
        token_wally_fase2: token_wally_fase2
    }).done(function (e) {
        1 == e.continuo_jugando ? ($(".js-promo-wally_fase2-step-2").html(e.html), promoWally_fase2Countdown(e._segundos), promoWally_actual_partida_item_id = $("#partida_item_id").val(), setTimeout(function () {
            $(".js-promo-wally-find-this--" + elementos[wallyTotalElements]).fadeIn().delay(1200).fadeOut("slow")
        }, 500), _id = $("#id").val(), $.post(_url_get_promo, {
            token_wally_fase2: token_wally_fase2,
            id_partida: _id,
            start_at: 1
        }).done(function (e) {})) : promoWally_fase2GoTo("3-gameover-no-partidas")
    })
}
function promoWally_fase2SiguienteIcono(e) {
    $(".js-icon").removeClass("active"), $(".js-icon-" + e).addClass("active"), $(".js-icon--" + elementos[wallyTotalElements]).removeClass("inactive")
}
function promoWally_fase2SendElementoEncontrado(e, t) {
    _url_get_promo = base_url_lang + "promo_wally/guardar_elemento_fase2", _id = $("#id").val(), $.post(_url_get_promo, {
        token_wally_fase2: token_wally_fase2,
        ...
        promoWally_actual_partida_item_id = e.partida_item_id, $("#partida_item_id").val(e.partida_item_id)
    })
}
function promoWally_fase2Encontrado(e) {
    promoWally_fase2Elemento = e, promoWally_fase2Elemento == elementos[wallyTotalElements] && (wallyElements[wallyTotalElements] = promoWally_fase2Elemento, wallyTotalElements += 1, promoWally_fase2SiguienteIcono(wallyTotalElements + 1), _nuevo_elemento = null, wallyTotalElements < 8 && (_nuevo_elemento = elementos[wallyTotalElements]), promoWally_fase2SendElementoEncontrado(e, _nuevo_elemento), $(".js-promo-wally-find-this--" + elementos[wallyTotalElements]).fadeIn().delay(1200).fadeOut("slow")), 8 == wallyTotalElements && (clearTimeout(promoWally_fase2Timer), $("#token_promo").val($("#token_find").val()), promoWally_fase2GoTo("3-win"), wally_fase2_finished = !0)
}
function promoWally_fase2EnviarForm() {
    return _id = $("#id").val(), _url_promo_form_fase2 = base_url_lang + "promo_wally/save_fase2", form_promo_wally_fase2() && ($("#promo_form_fase2 button").hide(), $.post(_url_promo_form_fase2, {
        nick: $("#wally-nick").val(),
        token_form: $("#token_form").val(),
        token_promo: $("#token_promo").val(),
        tmp_txt: $("#tmp_txt").val(),
        ...
        "OK" == e.status ? ($("#display_error").hide(), $("#promo_form_fase2").hide(), $("#display_ok").show(), promoWally_fase2GoToRanking()) : ($("#promo_form_fase2 button").show(), $("#display_error").show(), $("#errores_div").html(e.error_msg))
    })), !1
}
function promoWally_fase2GoToRanking() {
    promoWally_fase2GoTo("4-ranking"), _url_get_promo = base_url_lang + "promo_wally/ranking_fase2", $(".js-promo-wally_fase2-step-4-ranking").html('<div class="container-fluid container--812"><div class="promo-wally-loading"><div class="block-text"><p>Loading...</p></div></div></div>'), $.post(_url_get_promo, {
        token_wally_fase2: token_wally_fase2
    }).done(function (e) {
        $(".js-promo-wally_fase2-step-4-ranking").html(e.html)
    })
}
function searchProductsTagsClickCheckbox() {
    checkAvailableTags(), searchProductsTags(0)
}
function checkAvailableTags() {
    $(".typetag_all").addClass("hidden"), $(".typetag_familias input").each(function (e) {
        $(this).prop("checked") && $(".typetag_" + $(this).data("tag")).removeClass("hidden")
    })
}
function searchProductsTags(e) {
    delay = 1e3, e >= 1 && (delay = 0), e >= 1 ? ($(".products-filters__btns").remove(), $("#product_filters_ajax_results").html($("#product_filters_ajax_results").html() + '<img class="search__loading loading animation-spin js-search-loading" src="/images/icons/loading.svg" width="30" height="30" alt="Loading...">')) : $("#product_filters_ajax_results").html('<img class="search__loading loading animation-spin js-search-loading" src="/images/icons/loading.svg" width="30" height="30" alt="Loading...">'), clearTimeout(searchProductsTagsTimeout), searchProductsTagsTimeout = setTimeout(function () {
        _action_search = $("#current_url").val(), data = $(".typetag input").serialize(), data += "&search_products=1", data = data + "&page=" + e, $.post(_action_search, data, function (t) {
            e >= 1 ? ($(".js-search-loading").remove(), $("#product_filters_ajax_results").html($("#product_filters_ajax_results").html() + t)) : $("#product_filters_ajax_results").html(t), urlPath = $("#current_url").val(), urlPath = urlPath + "?" + data, window.history.pushState({
                html: t,
                pageTitle: "<?php echo $seo_title; ?>"
            }, "", urlPath), checkAvailableTags(), document.getElementById("cargar_mas_resultados").addEventListener("click", function (e) {
                e.preventDefault()
            })
        })
    }, delay)
...
function filtro_productos() {
    checkAvailableTags(), document.getElementById("cargar_mas_resultados") && document.getElementById("cargar_mas_resultados").addEventListener("click", function (e) {
        e.preventDefault()
    }), $(".js-product-filters").on("click", ".js-product-simple-link", function (e) {
        e.preventDefault(), $("#modal-article .product-simple__photo__img").attr("src", $(this).data("img")), $("#modal-article h3").html($(this).data("title")), $("#modal-article p").html($(this).data("description")), $("#modal-article .btn-rounded--outline-maroon").hide(), "" != $(this).data("enlace_ficha") && ($("#modal-article .js-ver_ficha").attr("href", $(this).data("enlace_ficha")), $("#modal-article .js-ver_ficha").show()), "" != $(this).data("enlace_informacion") && ($("#modal-article .js-informacion").attr("href", $(this).data("enlace_informacion")), $("#modal-article .js-informacion").show()), "" != $(this).data("enlace_galeria_imagenes") && ($("#modal-article .js-galeria_imagenes").attr("href", $(this).data("enlace_galeria_imagenes")), $("#modal-article .js-galeria_imagenes").show()), "" != $(this).data("enlace_descargas") && ($("#modal-article .js-descargas").attr("href", $(this).data("enlace_descargas")), $("#modal-article .js-descargas").show()), $(this).data("is_vertical"), $("#modal-article").modal("show")
    })
}! function (e, t) {
...
function (e, t) {
    ...
    function t() {
        e[n].glbl || (a = {
            ...
            return e + ".mm"
        }, s.add("transitionend webkitTransitionEnd mousedown mouseup touchstart touchmove touchend click keydown"), e[n]._c = o, e[n]._d = r, e[n]._e = s, e[n].glbl = a)
    }
    var n = "mmenu",
        i = "5.5.3";
        ...
        e[n] = function (e, t, n) {
            ...
            _initAnchors: function () {
                ...
                a.$body.on(s.click + "-oncanvas", "a[href]", function (i) {
                    ...
                    for (var l in e[n].addons) if (s = e[n].addons[l].clickAnchor.call(t, r, a)) break;
                    if (!s && a) {
                        var c = r.attr("href");
                    ...
                    if (s && i.preventDefault(), !s && a && r.is("." + o.listview + " > li > a") && !r.is('[rel="external"]') && !r.is('[target="_blank"]')) {
                        t.__valueOrFn(t.opts.onClick.setSelected, r) && t.setSelected(e(i.target).parent());
                        var h = t.__valueOrFn(t.opts.onClick.preventDefault, r, "#" == c.slice(0, 1));
                        h && i.preventDefault(), t.__valueOrFn(t.opts.onClick.close, r, h) && t.close()
                    }
                })
            },
    ...
    var e = function (e, t, n, i) {
        ...
        var c, u, d, h, p, f, m, g, v, y, b, T, w, _, S, C, x, A, P, E, M, $, I, k, D, H, G, B, O, N, L, j, R, F, W, V, z, q, X, U, K, Z, Y, Q, J, ee, te, ne, ie, oe, re, se, ae, le, ce, ue, de = function () {
            ...
            je = function () {
                ...
                o.bind(document, "keydown", r), L.transform && o.bind(r.scrollWrap, "click", r), l.mouseUsed || o.bind(document, "mousemove", je), o.bind(window, "resize scroll", r), Ee("bindEvents")
            }, Fe = function () {
                o.unbind(window, "resize", r), o.unbind(window, "scroll", v.scroll), o.unbind(document, "keydown", r), o.unbind(document, "mousemove", je), L.transform && o.unbind(r.scrollWrap, "click", r), q && o.unbind(window, m, r), Ee("unbindEvents")
            }, We = function (e, t) {
            ...
            wt = function (e, t) {
                ...
                return Et.prevent = !Pt(e.target, l.isClickableElement), Ee("preventDragEvent", e, t, Et), Et.prevent
            }, $t = function (e, t) {
    ...
    var e = function (e, t) {
        var n, i, o, r, s, a, l, c, u, d, h, p, f, m, g, v, y, b, T, w = this,
            ...
            x = {
                ...
                l.children[0].innerHTML = r, l.children[0].onclick = k
            }, H = function (e) {
        ...
        w.init = function () {
            t.extend(e.options, x, !0), g = e.options, i = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, W(), d("beforeChange", w.update), d("doubleTap", function (t) {
                ...
                t.bind(i, "pswpTap click", A), t.bind(e.scrollWrap, "pswpTap", w.onGlobalTap), e.likelyTouchDevice || t.bind(e.scrollWrap, "mouseover", w.onMouseOver)
            }), d("unbindEvents", function () {
                C || I(), b && clearInterval(b), t.unbind(document, "mouseout", O), t.unbind(document, "mousemove", B), t.unbind(i, "pswpTap click", A), t.unbind(e.scrollWrap, "pswpTap", w.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", w.onMouseOver), n && (t.unbind(document, n.eventK, w.updateFullscreen), n.isFullscreen() && (g.hideAnimationDuration = 0, n.exit()), n = null)
            }), d("destroy", function () {
...
var currentTabletNav = "",
    ...
    subnavIsHover = !1,
    subnavIsVisible = !1;
Modernizr.touchevents ? $(".js-main-nav-link").on("click", function (e) {
