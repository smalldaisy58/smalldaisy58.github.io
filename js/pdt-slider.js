  ...
  var ikSlider = function(el, options) {
    ...
    function init() {
      ...
      if (settings.arrows) {
        ...
        $arrows.on('mousedown.' + PLUGIN, function(e) {
          e.preventDefault();
    ...
    function _controls() {
      ...
      $controlPanel.on('mousedown.' + PLUGIN, '.slider-nav__control', function(e) {
        e.preventDefault();
    ...
    function destroy() {
      ...
      if (settings.arrows) {
        $arrows.off('mousedown.' + PLUGIN);
        $arrows.attr('disabled', false);
      }
      if (settings.controls) {
        $controlPanel.off('mousedown.' + PLUGIN).remove();
      }
